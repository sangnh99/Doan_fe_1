...
export default function RecommendListFood(props) {
  const [listRecommendItem, setListRecommendItem] = useState(null);
  ...
  return (
    <div style={{marginTop : 30, marginBottom : 57}}>
      {
        listRecommendItem != null ? (
          <Slider {...settings}>
                {
                  listRecommendItem.map(item => {
                    return (
